...
# include <cuimg/gpu/tracking/lgp82s.h>

# include <cuimg/gpu/tracking/fast382s_feature.h>
...
namespace cuimg
{
  ...
  */
  ...
  inline
  void
  lgp82s_feature::update(const image2d<i_float4>& in)
  {
  ...
  inline
  void
  lgp82s_feature::update(const image2d<i_float1>& gl_frame)
  {
    swap_buffers();
