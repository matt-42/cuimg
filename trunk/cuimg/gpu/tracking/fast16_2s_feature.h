...
namespace cuimg
{
  ...
  public:
    ...
    inline image2d<dfast16_2s>& previous_frame();
    inline image2d<dfast16_2s>& current_frame();
  ...
  private:
    ...
    image2d<dfast16_2s> f1_;
    image2d<dfast16_2s> f2_;

    image2d<dfast16_2s>* f_prev_;
    image2d<dfast16_2s>* f_;

    image2d<i_float4> fast162s_color_;
...
# include <cuimg/gpu/tracking/fast16_2s_feature.hpp>
