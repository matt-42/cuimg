...
namespace cuimg
{
  ...
  public:
    ...
    inline image2d<dlgp82s>& previous_frame();
    inline image2d<dlgp82s>& current_frame();
  ...
  private:
    ...
    image2d<dlgp82s>* f_prev_;
    image2d<dlgp82s>* f_;

    image2d<i_float4> lgp82s_color_;
...
# include <cuimg/gpu/tracking/lgp82s.hpp>
