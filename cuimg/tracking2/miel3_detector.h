#ifndef CUIMG_MIEL3_DETECTOR_H_
# define CUIMG_MIEL3_DETECTOR_H_
...
namespace cuimg
{
  ...
  class miel3_1s_detector
  {
  public:
    inline miel3_1s_detector(const obox2d& d);
    inline miel3_1s_detector(const miel3_1s_detector& d);
    ...
    inline miel3_1s_detector& set_contrast_threshold(float f);
...
# include <cuimg/tracking2/miel3_detector.hpp>
